...
- ⚙️ **Backend** → [https://github.com/lakshay-jainn/safe-space-be](https://github.com/lakshay-jainn/safe-space-be)
...
## ✨ Features
- 🕶️ **Anonymous Posting** — Share without attaching personal identity.  
